...
def test_chainer_mnist_single_machine(docker_image, opt_ml):
...
def test_chainer_mnist_custom_loop(docker_image, opt_ml):
    data_dir = join(dir_path, 'data')
...
def test_chainer_mnist_distributed(docker_image, opt_ml):
    data_dir = join(dir_path, 'data')
